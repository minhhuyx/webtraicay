                                        ...
                                        <form action="" method="post">
                                                ...
                                                <?php 
                                                     ...
                                                     while($row = $result->fetch_assoc()) {
                                                         ...
                                                         <td>$madanhmuc</td>
                                                         <td>
                                                             <img class='rounded service-img mr-1' src='$imagePath' alt='Hình ảnh danh mục'>$tendanhmuc</td>
                                                         <td>
													...
													<a href='xoadanhmuc.php' type='button'  class='btn btn-outline-danger btn-sm'><i class='fa fa-trash-o' ></i > Xóa</a>
												</td>
                                                         </tr>";
