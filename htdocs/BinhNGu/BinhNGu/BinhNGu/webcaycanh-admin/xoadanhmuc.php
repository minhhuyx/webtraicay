							...
							<div class="row filter-row">
								<div class="col-sm-6 col-md-3">
									<div class="form-group">
										...
										<select class="form-control select" name = "tendanhmuc">
									...
									<table class="table table-hover table-center mb-0 datatable">
										...
										<tbody>
											<tr>
												<td>1</td>
												<td>
													<img class="rounded service-img mr-1" src="assets/img/categories/cay-de-ban.jpg" alt="Hình ảnh danh mục">Cây để bàn</td>
												<td>
												...
												<td class="text-right">
													...
													<button type="button" name = "btnxoa" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash-o"></i> Xóa</button>
												</td>
											</tr>
											<tr>
												<td>2</td>
												<td>
													<img class="rounded service-img mr-1" src="assets/img/categories/cay-day-leo.jpg" alt="Hình ảnh danh mục">Cây dây leo</td>
												<td>
													<div class="status-toggle">
												...
												<form action="" method="post">
													...
													<a href="suadanhmuc.php" class="btn btn-sm bg-success-light mr-2">	<i class="far fa-edit mr-1"></i> Sửa</a>
													<a name = "btnxoa" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash-o"></i> Xóa</a>
												</form>
												</td>
											</tr>
											<tr>
												<td>3</td>
												<td>
													<img class="rounded service-img mr-1" src="assets/img/categories/cay-tet.jpg" alt="Hình ảnh danh mục">Cây tết</td>
												<td>
													<div class="status-toggle">
												...
												<td class="text-right">
													<a href="edit-category.html" class="btn btn-sm bg-success-light mr-2">	<i class="far fa-edit mr-1"></i> Sửa</a>
													<a class="btn btn-outline-danger btn-sm" name = "btnxoa"><i class="fa fa-trash-o"></i> Xóa</a>
												</td>
												</form>
											</tr>
											<tr>
												<td>4</td>
												<td>
													<img class="rounded service-img mr-1" src="assets/img/categories/cay-thuy-sinh.jpg" alt="Hình ảnh danh mục">Cây thủy sinh</td>
												<td>
													<div class="status-toggle">
											...
											<tr>
												<td>5</td>
												<td>
													<img class="rounded service-img mr-1" src="assets/img/categories/cay-trong-nha.jpg" alt="Hình ảnh danh mục">Cây trong nhà</td>
												<td>
													<div class="status-toggle">
											...
											<tr>
												<td>6</td>
												<td>
													<img class="rounded service-img mr-1" src="assets/img/categories/cay-ngoai-vuon.jpg" alt="Hình ảnh danh mục">Cây ngoài vườn</td>
												<td>
													<div class="status-toggle">
