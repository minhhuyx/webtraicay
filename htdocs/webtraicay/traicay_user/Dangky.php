...
<body>
    ...
    <!--    -->
    <div class="bg">
        <p class="bgchu"><a href="Trangchu.php" class="bgchu2">Trang chủ/</a> <span>Tài khoản/ Đăng ký</span> </p>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="form-container space-form">
                    ...
                    <form class="form" action="" method="POST">
                            ...
                            <input type="text" class="input" name="fullname" placeholder="Tên">
                            <input type="email" class="input" name="email" placeholder="Email">
                            <input type="tel" class="input" name="phone_number" placeholder="Số điện thoại">
                        ...
                        <button  name="btnluu" type="submit" class="form-btn" id="login-btn" disabled>Đăng ký</button>
                    </form>
                    <h5 class="sign-up-label">
                        Bạn đã sẳn sàng chưa?<span class="sign-up-link gach"><a href="login.php" class="gach"> Đăng nhập
                            </a></span>
                    </h5>
                </div>
