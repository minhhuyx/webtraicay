...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <!-- <div class="col-lg-10 menutr1"> <br/> <nav class="navbar navbar-expand-lg navbar-expand-md navbar-expand-lg">
                <div class="container-fluid">
  ...
  <!--Background đầu-->
  <div class="bg">
    <p class="bgchu"><a href="Trangchu.php" class="bgchu2">Trang chủ/</a> <span>Giỏ hàng</span> </p>
  </div>
  <!--thanh toán-->
  <div class="container top2">
    <div class="row">
      ...
      <div class="col-lg-7">
        <div class="border1">
          <p class="chu3">Giỏ hàng <i class="fab fa-apple"></i>
      ...
      <div class="col-lg-5 border2">
        <div class="">
          <p class="chu3">Thông tin đơn hàng <i class="fab fa-apple"></i></p>
        </div>
        ...
        <div class="button1">
          <button class="shop"><a href="#"><i class="fa fa-shopping-cart"></i></a></button>
        </div>
      </div>
      ...
      <div class="col-lg-12">
        ...
        <div class="col-lg-6 left">
          ...
          <p class="chu8"><a target="_blank"
              ...
              Minh</a></p>
          <p class="chu8"><a target="_blank" href="https://chat.zalo.me" class="bgft gach"><i class="fa fa-phone"
          ...
          <p class="chu8"><a target="_blank" href="Trangchu.php" class="bgft gach"><i class="fa fa-internet-explorer"
