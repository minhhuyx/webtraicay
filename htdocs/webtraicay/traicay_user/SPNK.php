...
<body>
  ...
  <div class="container mg center">
    <div class="row">
      <div class="col-lg-12">
        <button class="bt1">Trái cây Nhập khẩu</button>
      </div>
    </div>
  </div>
      ...
      <div class="col-lg-12">
        ...
        <div class="col-lg-2 card l">
          <div class="card-details">
            <img src="image/NK2.webp" style="width: 100%;" />
            <p class="text-title">Lê Korea</p>
            <p class="text-body">250.000₫</p>
          </div>
          <a target="_blank" href="chitietsp29.php">
        ...
        <div class="col-lg-2 card l">
          <div class="card-details">
            <img src="image/NK1.webp" style="width: 100%;" />
            <p class="text-title">Lê Japan</p>
            <p class="text-body">220.000₫</p>
          </div>
          <a target="_blank" href="chitietsp30.php">
            <div><button class="card-button">Mua hàng</button></div>
          </a>
        </div>
        ...
        <div class="col-lg-2 card l">
          <div class="card-details">
            <img src="image/NK3.webp" style="width: 100%;" />
            <p class="text-title">Nho Mỹ</p>
            <p class="text-body"><span>600.000₫</span> 550.000₫</p>
          </div>
          <a target="_blank" href="chitietsp31.php">
            <div><button class="card-button">Mua hàng</button></div>
          </a>
        </div>
        ...
        <div class="col-lg-2 card l">
          <div class="card-details">
            <img src="image/NK4.webp" style="width: 100%;" />
            <p class="text-title">Táo Japan</p>
            <p class="text-body">160.000₫</p>
          </div>
          <a target="_blank" href="chitietsp32.php">
            <div><button class="card-button">Mua hàng</button></div>
          </a>
        </div>
        ...
        <div class="col-lg-2 card l">
          <div class="card-details">
            <img src="image/NK5.webp" style="width: 100%;" />
            <p class="text-title">Nho Korea</p>
            <p class="text-body"><span>1.000.000₫</span> 500.000₫</p>
          </div>
          <a target="_blank" href="chitietsp33.php">
            <div><button class="card-button">Mua hàng</button></div>
          </a>
        </div>
        ...
        <div class="col-lg-2 card l">
          <div class="card-details">
            <img src="image/NK6.webp" style="width: 100%;" />
            <p class="text-title">Dâu Korea</p>
            <p class="text-body">760.000₫</p>
          </div>
          <a target="_blank" href="chitietsp34.php">
            <div><button class="card-button">Mua hàng</button></div>
          </a>
        </div>
        ...
        <div class="col-lg-2 card l">
          <div class="card-details">
            <img src="image/NK7.jpg" style="width: 100%;" />
            <p class="text-title">Kiwi France</p>
            <p class="text-body"><span>680.000₫</span> 500.000₫</p>
          </div>
          <a target="_blank" href="chitietsp35.php">
            <div><button class="card-button">Mua hàng</button></div>
          </a>
        </div>
        ...
        <div class="col-lg-2 card l">
          <div class="card-details">
            <img src="image/NK8.webp" style="width: 100%;" />
            <p class="text-title">Dưa lưới Japan</p>
            <p class="text-body"><span>280.000₫</span> 150.000₫</p>
          </div>
          <a target="_blank" href="chitietsp36.php">
            <div><button class="card-button">Mua hàng</button></div>
          </a>
        </div>
        ...
        <div class="col-lg-2 card l">
          <div class="card-details">
            <img src="image/NK9.webp" style="width: 100%;" />
            <p class="text-title">Việt quốc Singapore</p>
            <p class="text-body">400.000₫</p>
          </div>
          <a target="_blank" href="chitietsp37.php">
            <div><button class="card-button">Mua hàng</button></div>
          </a>
        </div>
        ...
        <div class="col-lg-2 card l">
          <div class="card-details">
            <img src="image/NK10.webp" style="width: 100%;" />
            <p class="text-title">Cherry NewZealand</p>
            <p class="text-body"><span>800.000₫</span> 620.000₫</p>
          </div>
          <a target="_blank" href="chitietsp38.php">
            <div><button class="card-button">Mua hàng</button></div>
          </a>
        </div>
