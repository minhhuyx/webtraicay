...
<body>
    ...
    <!--   -->
    <div class="bg">
        <p class="bgchu"><a href="Trangchu.php" class="bgchu2">Trang chủ/</a> <span>Chi tiết sản phẩm/ Táo Nevy</span>
        </p>
    </div>
        ...
        <div class="container mg1">
            <div class="row">
                <div class="col-lg-5 top1">
                    <img src="image/taoenvy.webp" class="col-lg-12 img-fluid hinhcho" id="mainID"
                        style="width: 100%;" />
                    <div class="hinh1">
                        <div class="col-lg-3"><img src="image/taoenvy.webp" style="width: 100%;" /></div>
                        <div class="col-lg-3 "><img src="image/taoenvy2.webp" style="width: 100%;" /></div>
                        <div class="col-lg-3"><img src="image/taoenvy3.webp" style="width: 100%;" /></div>
                ...
                <div class="col-lg-6 top1">
                    <p class="chu">Táo <i class="fab fa-apple"></i>
                    <ul class="rating">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <button class="shop" onclick="addToCart()">
                    ...
                    <p>Danh mục: <button class="button2"> Táo </button><button class="button2"> Táo </button> </p>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row trai">
                    ...
                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp4.php"><img src="image/dualuoi.webp"
                                    alt="" style="width: 100%; margin-bottom: 10px;"></a> Dưa lưới</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp5.php"><img src="image/nhoxanh.webp"
                                    alt="" style="width: 100%; margin-bottom: 10px;"></a> Nho xanh</p>
                    </div>
