...
<body>
    ...
    <!--   -->
    <div class="bg">
        <p class="bgchu"><a href="Trangchu.php" class="bgchu2">Trang chủ/</a> <span>Chi tiết sản phẩm/ Set 2</span>
        </p>
    </div>
            ...
            <div class="row">
                <div class="col-lg-5 ">
                    ...
                    <div class="img-magnifier-container">
                        <img id="myimage" src="image/gioqua2.jpg" style="width: 100%;" class="hinh20">
                    </div>
                    <script>
                        magnify("myimage", 3);
                    </script>
                ...
                <div class="col-lg-6 top1">
                    <p class="chu">Set 2 <i class="fab fa-apple"></i>
                    <ul class="rating">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row trai">
                    ...
                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp11.php"><img src="image/gioqua1.webp"
                                    alt="" style="width: 90%; margin-bottom: 10px;"></a> Set 1</p>
                    </div>
