...
<body>
    ...
    <!--   -->
    <div class="bg">
        <p class="bgchu"><a href="Trangchu.php" class="bgchu2">Trang chủ/</a> <span>Chi tiết sản phẩm/ Set 5</span>
        </p>
    </div>
            ...
            <div class="row">
                <div class="col-lg-5 ">
                    ...
                    <div class="img-magnifier-container">
                        <img id="myimage" src="image/gioqua5.jpg" style="width: 100%;" class="hinh20">
                    </div>
                    <script>
                        magnify("myimage", 3);
                    </script>
                ...
                <div class="col-lg-6 top1">
                    <p class="chu">Set 5 <i class="fab fa-apple"></i>
                    <ul class="rating">
