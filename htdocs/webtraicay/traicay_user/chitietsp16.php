...
<body>
    ...
    <!--   -->
    <div class="bg">
        <p class="bgchu"><a href="Trangchu.html" class="bgchu2">Trang chủ/</a> <span>Chi tiết sản phẩm/ Set 6</span>
        </p>
    </div>
            ...
            <div class="row">
                <div class="col-lg-5 ">
                    ...
                    <div class="img-magnifier-container">
                        <img id="myimage" src="image/gioqua6.webp" style="width: 100%;" class="hinh20">
                    </div>
                    <script>
                        magnify("myimage", 3);
                    </script>
                ...
                <div class="col-lg-6 top1">
                    <p class="chu">Set 6 <i class="fab fa-apple"></i>
                    <ul class="rating">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row trai">
                    ...
                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp12.html"><img src="image/gioqua2.webp"
                                    alt="" style="width: 90%; margin-bottom: 10px;"></a> Set 2</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp13.html"><img src="image/gioqua3.webp"
                                    alt="" style="width: 90%; margin-bottom: 10px;"></a> Set 3</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp18.html"><img src="image/gioqua8.webp"
                                    alt="" style="width: 90%; margin-bottom: 10px;"></a> Set 8</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp17.html"><img src="image/gioqua7.webp"
