...
<body>
    ...
    <!--   -->
    <div class="bg">
        <p class="bgchu"><a href="Trangchu.php" class="bgchu2">Trang chủ/</a> <span>Chi tiết sản phẩm/ Sầu Riêng</span>
        </p>
    </div>
        ...
        <div class="container mg1">
            <div class="row">
                <div class="col-lg-5 top1">
                    <img src="image/sau1.jpg" class="col-lg-12 img-fluid hinhcho" id="mainID" style="width: 100%;" />
                    <div class="hinh1">
                        <div class="col-lg-3"><img src="image/sau1.jpg" style="width: 100%;" /></div>
                        <div class="col-lg-3 "><img src="image/sau2.jpg" style="width: 100%;" /></div>
                ...
                <div class="col-lg-6 top1">
                    <p class="chu">Sầu Riêng <i class="fab fa-apple"></i>
                    <ul class="rating">
                    ...
                    <p>Danh mục: <button class="button2"> Sầu Riêng </button> </p>
