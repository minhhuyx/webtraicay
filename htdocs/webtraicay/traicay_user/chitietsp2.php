...
<body>
    ...
    <!--   -->
    <div class="bg">
        <p class="bgchu"><a href="Trangchu.php" class="bgchu2">Trang chủ/</a> <span>Chi tiết sản phẩm/ Nho mẫu
                đơn</span> </p>
    </div>
        ...
        <div class="container mg1">
            <div class="row">
                <div class="col-lg-5 top1">
                    <img src="image/nhomaudon.webp" class="col-lg-12 img-fluid hinhcho" id="mainID"
                        style="width: 100%;" />
                    <div class="hinh1">
                        <div class="col-lg-3"><img src="image/nhomaudon3.webp" style="width: 100%;" /></div>
                        <div class="col-lg-3 "><img src="image/nhomaudon2.webp" style="width: 100%;" /></div>
                        <div class="col-lg-3"><img src="image/nhomaudon.webp" style="width: 100%;" /></div>
                ...
                <div class="col-lg-6 top1">
                    <p class="chu">Nho mẫu đơn <i class="fab fa-apple"></i>
                    <ul class="rating">
                    ...
                    <p>Danh mục: <button class="button2"> Nho </button><button class="button2"> Nho mẫu đơn </button>
                    </p>
                ...
                <div class="row trai">
                    ...
                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp5.php"><img src="image/kiwivang.webp"
                                    alt="" style="width: 100%; margin-bottom: 10px;"></a>Kiwi vàng</p>
                    </div>
