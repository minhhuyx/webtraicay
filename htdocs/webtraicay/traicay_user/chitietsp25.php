...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-2 lg"> <a href="Trangchu.html"><img src="image/logo.jpg"
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="collapsibleNavbar">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="Gioithieu.html">LIÊN HỆ</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="Giohang.html"><i class="fa fa-shopping-cart"
                                            aria-hidden="true"></i> </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="Dangnhap.html"><i class="fa fa-user"
                                            aria-hidden="true"></i> </a>
                                </li>
                            </ul>
                        </div>
    ...
    <!--   -->
    <div class="bg">
        <p class="bgchu"><a href="Trangchu.html" class="bgchu2">Trang chủ/</a> <span>Chi tiết sản phẩm/ Dưa Lưới</span>
        </p>
    </div>
        ...
        <div class="container mg1">
            <div class="row">
                <div class="col-lg-5 top1">
                    <img src="image/VN7.webp" class="col-lg-12 img-fluid hinhcho" id="mainID" style="width: 100%;" />
                    <div class="hinh1">
                        <div class="col-lg-3"><img src="image/dualuoi.webp" style="width: 100%;" /></div>
                        <div class="col-lg-3 "><img src="image/VN7.webp" style="width: 100%;" /></div>
                        <div class="col-lg-3"><img src="image/dualuoi2.jpg" style="width: 100%;" /></div>
                ...
                <div class="col-lg-6 top1">
                    <p class="chu">Dưa Lưới <i class="fab fa-apple"></i>
                    <ul class="rating">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 button1">
                            <button class="shop"><a href="thanhtoancho1.html"><i
                    ...
                    <p>Danh mục: <button class="button2"> Dưa Lưới</button></p>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row trai">
                    ...
                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp20.html"><img src="image/buoi1.jpg"
                                    alt="" style="width: 100%; margin-bottom: 10px;"></a> Bưởi Tân Triều</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp21.html"><img src="image/VN3.jpg" alt=""
                                    style="width: 100%; margin-bottom: 10px;"></a> Cam Sành</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp22.html"><img src="image/VN4.webp" alt=""
                                    style="width: 100%; margin-bottom: 10px;"></a> Đu Đủ</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp29.html"><img src="image/chuoi2.jpg"
                                    alt="" style="width: 100%; margin-bottom: 10px;"></a> Chuối</p>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-lg-6 left">
                    ...
                    <p class="chuend"><a target="_blank" href="Trangchu.html" class="bgft"><i
                ...
                <div class="col-lg-3 left">
                    ...
                    <p class="left1"><a target="_blank"
                            href="https://www.visa.com.vn/vi_VN/pay-with-visa/security/secure-online-shopping.html"
