...
<body>
    ...
    <!--   -->
    <div class="bg">
        <p class="bgchu"><a href="Trangchu.php" class="bgchu2">Trang chủ/</a> <span>Chi tiết sản phẩm/ Mận</span> </p>
    </div>
        ...
        <div class="container mg1">
            <div class="row">
                <div class="col-lg-5 top1">
                    <img src="image/man1.jpg" class="col-lg-12 img-fluid hinhcho" id="mainID" style="width: 100%;" />
                    <div class="hinh1">
                        <div class="col-lg-3"><img src="image/man1.jpg" style="width: 100%;" /></div>
                        <div class="col-lg-3 "><img src="image/man2.jpg" style="width: 100%;" /></div>
                        <div class="col-lg-3"><img src="image/man3.jpg" style="width: 100%;" /></div>
                ...
                <div class="col-lg-6 top1">
                    <p class="chu">Mận <i class="fab fa-apple"></i>
                    <ul class="rating">
                    ...
                    <p>Danh mục: <button class="button2"> Mận </button></p>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row trai">
                    ...
                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp20.php"><img src="image/buoi1.jpg" alt=""
                                    style="width: 100%; margin-bottom: 10px;"></a> Bưởi Tân Triều</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp21.php"><img src="image/VN3.jpg" alt=""
                                    style="width: 100%; margin-bottom: 10px;"></a> Cam Sành</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp22.php"><img src="image/VN4.webp" alt=""
                                    style="width: 100%; margin-bottom: 10px;"></a> Đu Đủ</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp29.php"><img src="image/chuoi1.jpg"
