...
<body>
    ...
    <!--   -->
    <div class="bg">
        <p class="bgchu"><a href="Trangchu.php" class="bgchu2">Trang chủ/</a> <span>Chi tiết sản phẩm/ Táo Japan</span>
        </p>
    </div>
        ...
        <div class="container mg1">
            <div class="row">
                <div class="col-lg-5 top1">
                    <img src="image/NK4.webp" class="col-lg-12 img-fluid hinhcho" id="mainID" style="width: 100%;" />
                    <div class="hinh1">
                        <div class="col-lg-3"><img src="image/NK4.webp" style="width: 100%;" /></div>
                        <div class="col-lg-3 "><img src="image/taojapan1.jpg" style="width: 100%;" /></div>
                        <div class="col-lg-3"><img src="image/taojapan2.jpg" style="width: 100%;" /></div>
                ...
                <div class="col-lg-6 top1">
                    <p class="chu">Táo Japan <i class="fab fa-apple"></i>
                    <ul class="rating">
                    ...
                    <p>Danh mục: <button class="button2"> Táo </button><button class="button2"> Táo Japan </button> </p>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row trai">
                    ...
                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp29.php"><img src="image/NK2.webp" alt=""
                                    style="width: 100%; margin-bottom: 10px;"></a> Lê Korea</p>
                    </div>
