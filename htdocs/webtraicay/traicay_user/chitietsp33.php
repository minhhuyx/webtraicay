...
<body>
    ...
    <!--   -->
    <div class="bg">
        <p class="bgchu"><a href="Trangchu.php" class="bgchu2">Trang chủ/</a> <span>Chi tiết sản phẩm/ Nho Korea</span>
        </p>
    </div>
        ...
        <div class="container mg1">
            <div class="row">
                <div class="col-lg-5 top1">
                    <img src="image/NK5.webp" class="col-lg-12 img-fluid hinhcho" id="mainID" style="width: 100%;" />
                    <div class="hinh1">
                        <div class="col-lg-3"><img src="image/NK5.webp" style="width: 100%;" /></div>
                        <div class="col-lg-3 "><img src="image/nhokorea1.jpg" style="width: 100%;" /></div>
                        <div class="col-lg-3"><img src="image/nhokorea2.jpg" style="width: 100%;" /></div>
                ...
                <div class="col-lg-6 top1">
                    <p class="chu">Nho Korea <i class="fab fa-apple"></i>
                    <ul class="rating">
                    ...
                    <p>Danh mục: <button class="button2"> Nho </button><button class="button2"> Nho Korea </button> </p>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row trai">
                    ...
                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp30.php"><img src="image/NK1.webp" alt=""
                                    style="width: 100%; margin-bottom: 10px;"></a> Lê Japan</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp31.php"><img src="image/NK3.webp" alt=""
                                    style="width: 100%; margin-bottom: 10px;"></a> Nho Mỹ</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp32.php"><img src="image/NK4.webp" alt=""
                                    style="width: 100%; margin-bottom: 10px;"></a> Táo Japan</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp38.php"><img src="image/NK10.webp" alt=""
                                    style="width: 100%; margin-bottom: 10px;"></a> Cherry NewZealand</p>
                    </div>
