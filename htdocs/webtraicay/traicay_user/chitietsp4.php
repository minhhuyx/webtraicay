...
<body>
    ...
    <!--   -->
    <div class="bg">
        <p class="bgchu"><a href="Trangchu.php" class="bgchu2">Trang chủ/</a> <span>Chi tiết sản phẩm/ Dưa lưới Trung
                Quốc</span> </p>
    </div>
        ...
        <div class="container mg1">
            <div class="row">
                <div class="col-lg-5 top1">
                    <img src="image/dualuoi.webp" class="col-lg-12 img-fluid hinhcho" id="mainID"
                        style="width: 100%;" />
                    <div class="hinh1">
                        ...
                        <div class="col-lg-3"><img src="image/dualuoi3.jpg" style="width: 100%;" /></div>
                ...
                <div class="col-lg-6 top1">
                    <p class="chu">Dưa lưới Trung Quốc <i class="fab fa-apple"></i>
                    <ul class="rating">
                    ...
                    <p>Danh mục: <button class="button2"> Dưa lưới </p>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row trai">
                    ...
                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp3.php"><img src="image/cherry.webp"
                                    alt="" style="width: 100%; margin-bottom: 10px;"></a> Cherry</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp10.php"><img src="image/mannamphi2.jpg"
                                    alt="" style="width: 100%; margin-bottom: 10px;"></a> Mận Nam Phi</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp8.php"><img
                                    src="image/dau_han_quoc_330g__2__7142b9d1469a48648d945e6b1a62551a.jpg" alt=""
                                    style="width: 100%; margin-bottom: 10px;"></a> Dâu Korea</p>
                    </div>
