...
<body>
    ...
    <!--   -->
    <div class="bg">
        <p class="bgchu"><a href="Trangchu.html" class="bgchu2">Trang chủ/</a> <span>Chi tiết sản phẩm/ Quýt</span> </p>
    </div>
        ...
        <div class="container mg1">
            <div class="row">
                <div class="col-lg-5 top1">
                    <img src="image/quytchina.webp" class="col-lg-12 img-fluid hinhcho" id="mainID"
                        style="width: 100%;" />
                    <div class="hinh1">
                        <div class="col-lg-3"><img src="image/quytchina3.jpg" style="width: 100%;" /></div>
                        <div class="col-lg-3 "><img src="image/quytchina.webp" style="width: 100%;" /></div>
                        <div class="col-lg-3"><img src="image/quytchina2.jpg" style="width: 100%;" /></div>
                ...
                <div class="col-lg-6 top1">
                    <p class="chu">Quýt Trung Quốc <i class="fab fa-apple"></i>
                    <ul class="rating">
                    ...
                    <p>Danh mục: <button class="button2"> Quýt </button><button class="button2"> Quýt TQ </button> </p>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row trai">
                    ...
                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp5.html"><img src="image/kiwivang.webp"
                                    alt="" style="width: 100%; margin-bottom: 10px;"></a> Kiwi Gold</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp2.html"><img src="image/nhomaudon.webp"
                                    alt="" style="width: 100%; margin-bottom: 10px;"></a> Nho mẫu đơn</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp5.html"><img src="image/dualuoi.webp"
                                    alt="" style="width: 100%; margin-bottom: 10px;"></a> Dưa lưới</p>
                    </div>

                    <div class="col-lg-3">
                        <p class="chos chu3"><a target="_blank" href="chitietsp1.html"><img src="image/taoenvy.webp"
