                    ...
                    <div class="col-lg-6 left">
                        ...
                        <div>
                            <button onclick="document.getElementById('id01').style.display='block'"
                                style="width:auto;">Chỉnh sửa</button>
                            ...
                            <div id="id01" class="modal">
                                ...
                                <form class="modal-content" action="/action_page.php">
                                    <div class="container">
                                        ...
                                        <input type="text" placeholder="Number" name="text" required>
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <button type="submit" class="signupbtn">Chỉnh sửa</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<script>
    ...
    // When the user clicks the button, make the modal small
